            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        ...
                        <p class="animated bounceInLeft">Corona virus detection  <br/>
                        using  <br/>
                        chest X-Rays.</p>
                         ...
                         <div class="row vbh">
                             ...
                             <UploadImages onClick={() => window.open("../Components/image-upload.component.js")}/>
                             Upload a X-Ray </div>
                         </div>
                    </div>
                </div>
                ...
                <div class="carousel-item">
                    <img class="d-block w-100" src="assets\images\slider\slider_3.jpg" alt="Third slide"/>
                     <div class="carousel-caption vdg-cur d-none d-md-block">
                        ...
                        <p class="animated bounceInLeft">COVID-19 vaccines have reached billions of people worldwide,  <br/>
                        the evidence is overwhelming that no matter which one you take, <br/>
                        the vaccines offer life-saving protection against a disease that has killed millions. </p>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        ...
                        <p class="animated bounceInLeft">Nearest Covid-19 and Non Covid-19  <br/>
